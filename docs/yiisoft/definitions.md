...
The package provides syntax constructs describing a way to create and configure a service or an object. It is used by [yiisoft/di](/yiisoft/di) and [yiisoft/factory](https://github.com/yiisoft/factory)
