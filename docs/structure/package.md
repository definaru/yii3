...
Classes from the package will be available immediately via [autoloading](/concept/autoloading).
...
everything is in good shape. For more details, please refer to the [Testing](/testing/overview) section.
