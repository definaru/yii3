...
::: tip **Note:** 
Use [Each] rule to validate multiple values of the same type.
:::
...
::: tip **Note:** 
Use [Nested] rule to validate nested arrays and [Each] rule to validate multiple arrays.
:::
