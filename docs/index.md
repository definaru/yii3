...
hero:
  name: Yii Framework
  text: Yii 3.0 related documentation
  tagline: A simple, powerful and fast framework. Meet the modern, definitive guide to Yii you've always wanted.
  actions:
    - theme: brand
      text: Get Started
      link: /intro/what-is-yii
    - theme: alt
      text: View on GitHub
      link: https://github.com/yiisoft/app
  image:
    src: https://raw.githubusercontent.com/yiisoft/docs/master/images/yii_logo.svg
    alt: Yii Framework
