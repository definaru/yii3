...
::: tip Info: 
You may skip this subsection for now if you're just test-driving Yii with no intention
...
::: tip Info: 
If your application runs in a shared hosting environment where you don't have permission
...
[Trusted proxies and headers](/security/trusted-request).
:::


### Apache

Use the following configuration in Apache's `httpd.conf` file or within a virtual host configuration. Note that you should replace `path/to/app/public` with the actual path for `app/public`.
...
Also, the following list of Microsoft's official resources could be useful to configure PHP on IIS:
 ...
 1. [How to set up your first IIS website](https://support.microsoft.com/en-us/help/323972/how-to-set-up-your-first-iis-web-site) &#10008; error 404
